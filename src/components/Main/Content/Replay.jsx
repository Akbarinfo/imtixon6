...
export default function Replay({replay, key}) {
  return(
      <div className="comment__inputbox">
        <textarea className="comment__input comment__inputr" name="comment" id="" cols="30" rows="10">
        </textarea>
        ...
        <div className="d-flex align-items-center justify-content-between">
          ...
          <div className="d-flex align-items-center">
            ...
            <button className="comment__rbtn">Respond</button>
          </div>
        </div>
      </div>
  )

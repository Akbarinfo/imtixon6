...
export default function ContentInfo({content, name}) {
  ...
  let like_ = Math.floor((Math.random() * 100) + 1)
  let [like, setLike] = useState(like_)
  ...
  return(
    <div className="container d-flex justify-content-between">
      <Navbar />
         <section className="conte col-5">
           {
             content.map((item, id) => {
               if(+item.id === +location.pathname.split("/").at(-1)) {
                return(

                  <div key={654+id} id={id+82} className="conte__main">
                  <div className="d-flex align-items-center justify-content-between mb-5">
                    <div className="d-flex align-items-center">
                      <div className="conte__avabox">
                        <img className="conte__ava" src={item.avatar} alt={item.name} />
                      </div>
                      <div className="ms-3">
                        <h2 className="conte__name">{item.name}</h2>
                        <div className="d-flex conte__info">
                          <span className="me-1">{item.data}</span> ·
                          <span className="ms-1 me-1">{item.read}</span> ·
                          <span className="ms-1 conte__listen d-flex align-items-center"><i className='bx bx-play-circle me-2'></i> Listen</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="conte__box">
                      <h2 className="conte__title">{item.title}</h2>
                      <div className="conte__imgbox">
                        <img className="conte__img" src={item.img} alt={item.name} />
                      </div>
                      <p className="conte__text">
                        {item.text}
                      </p>
                  </div>
                    <div className="conte__cmbox d-flex">
                      <button onClick={likeHandler} className="conte__cmbtn">
                        <svg
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
                      ...
                      <button onClick={mopenHandler} className="conte__cmbtn"><svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                      ...
                      <button className="conte__cmbtn"><i className='conte__dicon bx bx-dots-horizontal-rounded'></i></button>
                    </div>
                    <Comment
                      item={item}
                      block={block}
